...
function ws_connect(addr) {
    ...
    socket.onmessage = function(msg) {
        ...
        // var buffer = encoder.encode(msg.data);
        // console.log(buffer);
        received_buffer.push(msg.data);
        console.log(received_buffer);
    }
};

function ws_send(data) {
    var consumed = consume_js_object(data);
    socket.send(consumed);
};
