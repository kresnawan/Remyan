...
function assert(e, t) { e == !1 && alert(t) }
    ...
    for (var n, a, r, c, s = 0, l = s + t, o = ""; !(s >= l);) {
        ...
        r = i[s++] & 63,
            (n & 240) == 224 ?
                n = (n & 15) << 12 | a << 6 | r :
                ((n & 248) != 240 &&
                    console.warn("Invalid UTF-8 leading byte 0x" + n.toString(16) +
                        " encountered when deserializing a UTF-8 string on the asm.js/wasm heap to a JS string!"
                    ),
                    n = (n & 7) << 18 | a << 12 | r << 6 | i[s++] & 63), n < 65536 ?
                o += String.fromCharCode(n) :
...
function stringToUTF8(e, t, n, s) {
    for (var o, r, c = n, i = n + s, a = 0; a < e.length; ++a)
        if (o = e.charCodeAt(a), o >= 55296 && o <= 57343 && (r = e.charCodeAt(++a), o = 65536 + ((o & 1023) << 10) | r & 1023), o <= 127) {
            ...
            if (n + 3 >= i) break;
            o >= 2097152 && console.warn("Invalid Unicode code point 0x" + o.toString(16) +
                ...
                t[n++] = 240 | o >> 18, t[n++] = 128 | o >> 12 & 63, t[n++] = 128 | o >> 6 & 63, t[n++] = 128 | o & 63
        }
    return n - c
...
FS = {
    ...
    GL = {
        ...
        validateGLObjectID: function (e, t, n, s) {
            t != 0 && (e[t] === null ?
                console.error(n + " called with an already deleted " + s + " ID " + t + "!") : e[t] ||
                console.error(n + " called with an invalid " + s + " ID " + t + "!"))
        },
        getSource: function (e, t, n, s) {
            for (var a, i = "", o = 0; o < t; ++o)
                a = s == 0 ? void 0 :
                    getArray(s + o * 4, Uint32Array, 1)[0], i += UTF8ToString(getArray(n + o * 4, Uint32Array, 1)[0], a);
            return i
        },
        ...
        populateUniformTable: function (e) {
            ...
            for (var t, n, s, i, a, l, o = GL.programs[e], r = GL.programInfos[e] = {
                ...
                if (i = gl.getActiveUniform(o, c), t = i.name,
                    r.maxUniformLength = Math.max(r.maxUniformLength, t.length + 1),
                    t.slice(-1) == "]" && (t = t.slice(0, t.lastIndexOf("["))),
                    n = gl.getUniformLocation(o, t), n) {
                    s = GL.getNewId(GL.uniforms), d[t] = [i.size, s],
                        GL.uniforms[s] = n;
                    for (a = 1; a < i.size; ++a)
                        l = t + "[" + a + "]", n = gl.getUniformLocation(o, l),
                            s = GL.getNewId(GL.uniforms), GL.uniforms[s] = n
                }
        }
    };
...
function _webglGet(e, t, n) {
    if (!t) {
        console.error("GL_INVALID_VALUE in glGet" + n +
            "v(name=" + e + ": Function called with null out pointer!"),
            GL.recordError(1281);
        return
    }
    ...
    switch (e) {
        ...
        case 36344:
            n != "EM_FUNC_SIG_PARAM_I" && n != "EM_FUNC_SIG_PARAM_I64" &&
                (GL.recordError(1280), err("GL_INVALID_ENUM in glGet" +
                    n + "v(GL_SHADER_BINARY_FORMATS): Invalid parameter type!"));
            return;
        ...
        case 33308: assert(!1, "unimplemented");
            break
    }
    ...
    if (o === void 0)
        switch (s = gl.getParameter(e), typeof s) {
            ...
            case "boolean": o = s ? 1 : 0; break;
            case "string": GL.recordError(1280), console.error("GL_INVALID_ENUM in glGet"
                + n
                + "v("
                + e
            ...
            case "object": if (s === null) switch (e) {
                case 34964:
                case 35725:
                case 34965:
                case 36006:
                ...
                try {
                    ...
                    GL.recordError(1280),
                        console.error("GL_INVALID_ENUM in glGet"
                            + n
...
function resize(e, t) {
    var o = dpi_scale(), n = e.clientWidth * o, s = e.clientHeight * o;
...
const SAPP_EVENTTYPE_TOUCHES_BEGAN = 10, SAPP_EVENTTYPE_TOUCHES_MOVED = 11, SAPP_EVENTTYPE_TOUCHES_ENDED = 12,
    SAPP_EVENTTYPE_TOUCHES_CANCELED = 13, SAPP_MODIFIER_SHIFT = 1, SAPP_MODIFIER_CTRL = 2, SAPP_MODIFIER_ALT = 4,
    SAPP_MODIFIER_SUPER = 8;

function into_sapp_mousebutton(e) {
    switch (e) { case 0: return 0; case 1: return 2; case 2: return 1; default: return e }
}
...
function mouse_relative_position(e, t) {
    var n = canvas.getBoundingClientRect(), s = (e - n.left) * dpi_scale(), o = (t - n.top) * dpi_scale(); return { x: s, y: o }
}

emscripten_shaders_hack = !1, importObject = {
    env: {
        ...
        now: function () {
            ...
            GL.validateGLObjectID(GL.uniforms, e, "glUniform1fv", "location"), assert((n & 3) == 0,
                "Pointer to float data passed to glUniform1fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 1 * t); gl.uniform1fv(GL.uniforms[e], s)
        }, glUniform2fv: function (e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform2fv", "location"), assert((n & 3) == 0,
                "Pointer to float data passed to glUniform2fv must be aligned to four bytes!");
            var s = getArray(n, Float32Array, 2 * t); gl.uniform2fv(GL.uniforms[e], s)
        }, glUniform3fv: function (e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform3fv", "location"), assert((n & 3) == 0,
            ...
            GL.validateGLObjectID(GL.uniforms, e, "glUniform4fv", "location"), assert((n & 3) == 0,
        ...
        glUniform1iv: function (e, t, n) {
            ...
            var s = getArray(n, Int32Array, 1 * t); gl.uniform1iv(GL.uniforms[e], s)
        ...
        glUniform3iv: function (e, t, n) {
            ...
            var s = getArray(n, Int32Array, 3 * t); gl.uniform3iv(GL.uniforms[e], s)
        },
        glUniform4iv: function (e, t, n) {
            GL.validateGLObjectID(GL.uniforms, e, "glUniform4fv", "location"), assert((n & 3) == 0,
                "Pointer to i32 data passed to glUniform4iv must be aligned to four bytes!");
            var s = getArray(n, Int32Array, 4 * t); gl.uniform4iv(GL.uniforms[e], s)
            ...
            GL.validateGLObjectID(GL.programs, e, "glGetUniformLocation", "program"),
                t = UTF8ToString(t); var s, o, n = 0;
            return t[t.length - 1] == "]" && (s = t.lastIndexOf("["), n = t[s + 1] != "]" ?
                parseInt(t.slice(s + 1)) : 0, t = t.slice(0, s)),
                o = GL.programInfos[e] && GL.programInfos[e].uniforms[t], o && n >= 0 && n < o[0] ?
                    o[1] + n : -1
        },
        ...
        glLinkProgram: function (e) {
            GL.validateGLObjectID(GL.programs, e, "glLinkProgram", "program"),
                gl.linkProgram(GL.programs[e]), GL.populateUniformTable(e)
        ...
        glGetProgramiv: function (e, t, n) {
            ...
            if (!o) {
                console.error("GL_INVALID_OPERATION in glGetProgramiv(program=" + e + ", pname=" +
                    t +
                    ", p=0x" +
                    n.toString(16) +
            ...
            if (t == 35716)
                ...
                console.error("unsupported operation"); return
            } else
                getArray(n, Int32Array, 1)[0] = gl.getProgramParameter(GL.programs[e], t)
        }, glCreateShader: function (e) {
            var t = GL.getNewId(GL.shaders); return GL.shaders[t] = gl.createShader(e), t
        ...
        }, glFrontFace: function (e) { gl.frontFace(e) },
        glCullFace: function (e) { gl.cullFace(e) },
        glCopyTexImage2D: function (e, t, n, s, o, i, a, r) {
            ...
            emscripten_shaders_hack && (o = o.replace(/#extension GL_OES_standard_derivatives : enable/g, ""),
                o = o.replace(/#extension GL_EXT_shader_texture_lod : enable/g, ""), i = "",
                ...
                o = o.replace(/textureCubeLodEXT/g, "textureCubeLod"), o = o.replace(/texture2DLodEXT/g, "texture2DLod"),
                ...
                o = o.replace(/#version 100/g, `#version 300 es` + i)),
        ...
        glGetProgramInfoLog: function (e, t, n, s) {
            ...
            var o, i = gl.getProgramInfoLog(GL.programs[e]); assert(i !== null);
            let a = getArray(s, Uint8Array, t);
            for (o = 0; o < t; o++)
                a[o] = i.charCodeAt(o)
        }, glGetString: function (e) {
            var t = gl.getParameter(e).toString(), n = t.length + 1,
            ...
            if (assert(n), GL.validateGLObjectID(GL.shaders, e, "glGetShaderiv", "shader"), t == 35716) {
                var s, i, o = gl.getShaderInfoLog(GL.shaders[e]); assert(o !== null), getArray(n, Int32Array, 1)[0] = o.length + 1
            } else
                t == 35720 ?
                    (s = gl.getShaderSource(GL.shaders[e]), i = s === null || s.length == 0 ?
                        0 : s.length + 1, getArray(n, Int32Array, 1)[0] = i) :
            ...
            assert(i !== null); let a = getArray(s, Uint8Array, t);
            for (o = 0; o < t; o++)
                a[o] = i.charCodeAt(o)
            ...
            var t = GL.shaders[e]; if (t == null) return; gl.deleteShader(t), GL.shaders[e] = null
        }, glDeleteProgram: function (e) {
            var t = GL.programs[e]; if (t == null) return; gl.deleteProgram(t), GL.programs[e] = null
        }, glDeleteBuffers: function (e, t) {
            for (var n, o, s = 0; s < e; s++) {
                if (o = getArray(t + s * 4, Uint32Array, 1)[0], n = GL.buffers[o], !n)
                    continue;
            ...
            for (var n, o, s = 0; s < e; s++) {
                if (o = getArray(t + s * 4, Uint32Array, 1)[0], n = GL.textures[o], !n)
                    continue;
        ...
        }, glEndQuery: function (e) { gl.endQuery(e) },
        glGetQueryObjectiv: function (e, t, n) {
            GL.validateGLObjectID(GL.timerQueries, e, "glGetQueryObjectiv", "id");
            let s = gl.getQueryObject(GL.timerQueries[e], t); getArray(n, Uint32Array, 1)[0] = s
            ...
            let o = gl.getQueryObject(GL.timerQueries[e], t),
                s = getArray(n, Uint32Array, 2); s[0] = o, s[1] = (o - s[0]) / 4294967296
            ...
            canvas.onmousemove = function (e) {
                var t = mouse_relative_position(e.clientX, e.clientY), n = t.x, s = t.y;
                wasm_exports.mouse_move(Math.floor(n), Math.floor(s)), (e.movementX != 0 || e.movementY != 0) &&
                ...
                var t = mouse_relative_position(e.clientX, e.clientY), n = t.x, s = t.y, o = into_sapp_mousebutton(e.button);
                ...
                n = 0, e.ctrlKey && (n |= SAPP_MODIFIER_CTRL),
                ...
                var t = into_sapp_keycode(e.code); let n = t == 261 || e.ctrlKey;
                ...
                t != null && t.length != 0 && (n = (new TextEncoder).encode(t).length,
                    s = wasm_exports.allocate_vec_u8(n), o = new Uint8Array(wasm_memory.buffer, s, n),
                    stringToUTF8(t, o, 0, n), wasm_exports.on_clipboard_paste(s, n))
            }), window.ondragover = function (e) {
                e.preventDefault()
            }, window.ondrop = async function (e) {
                e.preventDefault(), wasm_exports.on_files_dropped_start();
                for (let n of e.dataTransfer.files) {
                    const t = n.name.length, o = wasm_exports.allocate_vec_u8(t),
                        r = new Uint8Array(wasm_memory.buffer, o, t);
                    stringToUTF8(n.name, r, 0, t);
                    const i = await n.arrayBuffer(),
                        s = i.byteLength, a = wasm_exports.allocate_vec_u8(s),
            ...
            let n = document.hasFocus(); var t = function () {
                let e = document.hasFocus(); n == e && (wasm_exports.focus(e), n = e)
            };
            ...
            var s, o = UTF8ToString(e, t),
                n = FS.unique_id; return FS.unique_id += 1,
                    s = new XMLHttpRequest,
                    s.open("GET", o, !0),
                    s.responseType = "arraybuffer",
                    s.onreadystatechange = function () {
                        if (this.readyState === 4) if (this.status === 200) {
                            var e = new Uint8Array(this.response); FS.loaded_files[n] = e, wasm_exports.file_loaded(n)
            ...
            for (s = 0; s < o.length; s++)
                i[s] = o[s]; delete FS.loaded_files[e]
            ...
            let e = document.fullscreenElement; return e != null && e.id == canvas.id
...
function init_plugins(e) {
    ...
    for (var n, s, t = 0; t < e.length; t++)
        e[t].on_init != void 0 && e[t].on_init != null && e[t].on_init(), e[t].name == void 0 ||
            e[t].name == null || e[t].version == void 0 || e[t].version == null ?
            ...
            (n = e[t].name + "_crate_version", wasm_exports[n] == void 0 ?
                console.log("Plugin " + e[t].name + " is present in JS bundle, but is not used in the rust code.") :

                (s = wasm_exports[n](), e[t].version != s &&
                    console.error("Plugin " + e[t].name + " version mismatchjs version: " + e[t].version + ", crate version: " + s))
            )
}
...
function load(e) {
    ...
    register_plugins(plugins),
        typeof WebAssembly.compileStreaming == "function" ?
            WebAssembly.compileStreaming(t).then(e => (
                add_missing_functions_stabs(e), WebAssembly.instantiate(e, importObject))).then(e => {
                    ...
                    version != t && console.error("Version mismatch: gl.js version is: " + version + ", miniquad crate version is: " + t),
                        init_plugins(plugins), e.exports.main()
            ...
            t.then(function (e) {
                ...
                wasm_memory = e.exports.memory, wasm_exports = e.exports;
                var t = wasm_exports.crate_version(); version != t &&
                    console.error("Version mismatch: gl.js version is: " + version + ", rust sapp-wasm crate version is: " + t),
                    init_plugins(plugins), e.exports.main()
            }).catch(e => {
...
(function () {
    ...
    function d() {
        if (e == null) {
            ...
            {
                let s = window.AudioContext || window.webkitAudioContext, n = new s;
                var t = function () {
                    console.log("fix"), e.resume();
                    var i = n.createBuffer(1, 1, 22050),
                        o = n.createBufferSource();
                    o.buffer = i,
                        o.connect(n.destination), o.start ?
                            o.start(0) :
                            o.play ?
                                o.play(0) :
                                o.noteOn && o.noteOn(0),
    ...
    function r(t, s) {
        let a = wasm_memory.buffer.slice(t, t + s), i = o;
        return o += 1, e.decodeAudioData(a, function (e) {
            n.set(i, e)
        },
            function (e) {
    ...
    function l() {
        ...
        return n != null ? n.source = e.createBufferSource() :
            (n = { sound_key: 0, playback_key: 0, source: e.createBufferSource(), gain_node: e.createGain(), ended: null }, t.push(n)),
            n
    }
    function s(e) {
        try {
    ...
    function u(t, o, i) {
        ...
        a.sound_key = t,
            ...
            a.gain_node.gain.value = o, a.source.loop = i,
            a.ended = function () { s(a) },
    ...
    function h(e, n) {
        t.forEach(t => { t.sound_key === e && (t.gain_node.gain.value = n) })
    }
    function i(e) {
        t.forEach(t => { t.sound_key === e && s(t) })
    }
    function f(e) {
        i(e), n.delete(e)
    }
    function p(e) {
        let n = t.find(t => t.playback_key === e); n != null && s(n)
    }
    function g(e, n) {
        let s = t.find(t => t.playback_key === e); s != null && (s.gain_node.gain.value = n)
    }
    function v(e) {
        e.env.audio_init = d,
    ...
    function () {
        "use strict";
        var n, i = null, e = {}; e[-1] = null, e[-2] = void 0, n = 0;

        function o(n) {
            n.env.js_create_string = function (e, n) {
                var s = UTF8ToString(e, n); return t(s)
            }, 
            n.env.js_create_buffer = function (e, n) {
                var s = new Uint8Array(wasm_memory.buffer, e, n), o = new Uint8Array(new ArrayBuffer(s.byteLength));
            ...
            n.env.js_string_length = function (t) {
                var n = e[t]; return s(n).length
            }, 
            n.env.js_buf_length = function (t) {
                var n = e[t]; return n.length
            }, 
            ...
            n.env.js_field_u32 = function (t, n, s) {
                ...
                console.log(s);
                var o = UTF8ToString(n, s);
                return js_objects[t][o]
            }, 
            n.env.js_field = function (n, s, o) {
                var i = UTF8ToString(s, o), a = e[n][i];
                return t(a)
            }, 
        ...
        function s(e) {
            for (var t, n = [], s = 0; s < e.length; s++)
                t = e.charCodeAt(s), t < 128 ?
                    n.push(t) :
                    t < 2048 ?
                        n.push(192 | t >> 6, 128 | t & 63) :
                        t < 55296 || t >= 57344 ?
                            n.push(224 | t >> 12, 128 | t >> 6 & 63, 128 | t & 63) :
                            (s++, t = 65536 + ((t & 1023) << 10 | e.charCodeAt(s) & 1023),
                                n.push(240 | t >> 18, 128 | t >> 12 & 63, 128 | t >> 6 & 63, 128 | t & 63));

            return n
        } function t(t) {
            if (t == null) return -2; if (t === null) return -1; var s = n; return e[s] = t, n += 1, s
        } function a(t) {
    ...
    function () {
        ...
        miniquad_add_plugin({
            register_plugin: d, on_init: l, version: 1, name: "quad_net"
        });
        ...
        function u(t) {
            if (e[t] != void 0 && e[t] != null) {
                var n = e[t]; return e[t] = null, js_object(n)
            } return -1
        } 
        ...
        function h(t, n, o, i) {
            ...
            return a.onload = function () {
                if (this.status == 200) { var n = new Uint8Array(this.response); e[l] = n }
